...
```{r "hypothesis1a", echo = FALSE, message=FALSE}

columnNames <- c("Entity Type", "Name", "JMeter label", "Variation", "mean [ms]", "median [ms]", "90th p [ms]", "throughput [req/s]", "Service Replication Level", "Median Service Replication", "Smallest Replication Value")
columnAlignment <- "llllccccccc"
withTableStyling<- function(kTable) {
  ...
  column_spec(c(1:11), width = "15em", latex_valign = "m") %>%
...
withTableStyling(kable(hypothesis1a, 
      label = NA,
      caption = "Hypothesis 1a: A higher service replication has a positive impact on time-behavior for the original TeaStore application",
...
```{r "hypothesis1b", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis1b, 
      label = NA,
      caption = "Hypothesis 1b: A higher service replication has a positive impact on time-behavior for the TeaStore application while using a cloud database. ",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis1c", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis1c, 
      label = NA,
      caption = "Hypothesis 1c: A higher service replication has a positive impact on time-behavior for the TeaStore application while using a cloud database with one replica database",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis1d", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis1d, 
      label = NA,
      caption = "Hypothesis 1d: A higher service replication has a positive impact on time-behavior for the TeaStore application while using a cloud database with two replica databases",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis1e", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis1e, 
      label = NA,
      caption = "Hypothesis 1e: A higher service replication has a positive impact on time-behavior for the TeaStore application while using no caching at all.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis1f", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis1f, 
      label = NA,
      caption = "Hypothesis 1f: A higher service replication has a positive impact on time-behavior for the TeaStore application while using extensive caching.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis2a", echo = FALSE, message=FALSE}

columnNames <- c("Entity Type", "Name", "JMeter label", "Variation", "success rate [%]", "Service Replication Level", "Median Service Replication", "Smallest Replication Value")
columnAlignment <- "llllcccc"
withTableStyling<- function(kTable) {
  kTable %>%
  kable_styling(font_size = 11, bootstrap_options = "bordered") %>%
  row_spec(0,bold=TRUE, hline_after=TRUE) %>% 
  column_spec(c(1:8), width = "15em", latex_valign = "m") %>%
  #column_spec(1, width = "15em", latex_valign = "m") %>%
  #column_spec(c(2:3), latex_valign = "m") %>%
  #column_spec(c(4:11), latex_valign = "m") %>%
  #kable_styling(font_size = 10, latex_options=c("scale_down", "HOLD_position")) %>%
...
withTableStyling(kable(hypothesis2a, 
      label = NA,
      caption = "Hypothesis 2a: A higher service replication has a positive impact on availability for the original TeaStore application",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis2b", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis2b, 
      label = NA,
      caption = "A higher service replication has a positive impact on availability for the original TeaStore application while using no caching at all.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis2c", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis2c, 
      label = NA,
      caption = "A higher service replication has a positive impact on availability for the original TeaStore application while using extensive caching.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis3a", echo = FALSE, message=FALSE}

columnNames <- c("Entity Type", "Name", "JMeter label", "Variation", "mean [ms]", "median [ms]", "90th p [ms]", "throughput [req/s]", "Storage Replication Level")
columnAlignment <- "llllccccc"
withTableStyling<- function(kTable) {
  kTable %>%
  kable_styling(font_size = 11, bootstrap_options = "bordered") %>%
  row_spec(0,bold=TRUE, hline_after=TRUE) %>% 
  column_spec(c(1:9), width = "15em", latex_valign = "m") %>%
  #column_spec(1, width = "15em", latex_valign = "m") %>%
  #column_spec(c(2:3), latex_valign = "m") %>%
  #column_spec(c(4:11), latex_valign = "m") %>%
  #kable_styling(font_size = 10, latex_options=c("scale_down", "HOLD_position")) %>%
...
withTableStyling(kable(hypothesis3a, 
      label = NA,
      caption = "A higher horizontal data replication has a positive impact on time-behavior for the TeaStore application while there is no service replication.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis3b", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis3b, 
      label = NA,
      caption = "A higher horizontal data replication has a positive impact on time-behavior for the TeaStore application while there is a low service replication.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis3c", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis3c, 
      label = NA,     
      caption = "A higher horizontal data replication has a positive impact on time-behavior for the TeaStore application while there is a high service replication.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis3d", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis3d, 
      label = NA,                 
      caption = "A higher horizontal data replication has a positive impact on time-behavior for the TeaStore application while using no caching at all.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis3e", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis3e, 
      label = NA,                 
      caption = "A higher horizontal data replication has a positive impact on time-behavior for the TeaStore application while using some caching",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis3f", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis3f, 
      label = NA,                 
      caption = "A higher horizontal data replication has a positive impact on time-behavior for the TeaStore application while using extensive caching.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis4a", echo = FALSE, message=FALSE}

columnNames <- c("Entity Type", "Name", "JMeter label", "Variation", "mean [ms]", "median [ms]", "90th p [ms]", "throughput [req/s]", "Ratio of Cached Data Aggregates", "Data Replication along Request Trace")
columnAlignment <- "llllcccccc"
withTableStyling<- function(kTable) {
  kTable %>%
  kable_styling(font_size = 11, bootstrap_options = "bordered") %>%
  row_spec(0,bold=TRUE, hline_after=TRUE) %>% 
  column_spec(c(1:10), width = "15em", latex_valign = "m") %>%
  #column_spec(1, width = "15em", latex_valign = "m") %>%
  #column_spec(c(2:3), latex_valign = "m") %>%
  #column_spec(c(4:11), latex_valign = "m") %>%
  #kable_styling(font_size = 10, latex_options=c("scale_down", "HOLD_position")) %>%
...
withTableStyling(kable(hypothesis4a, 
      label = NA,                 
      caption = "A higher vertical data replication has a positive impact on time-behavior for the TeaStore application while no service replication is used.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis4b", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis4b, 
      label = NA,                 
      caption = "A higher vertical data replication has a positive impact on time-behavior for the TeaStore application while using a cloud database",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis4c", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis4c, 
      label = NA,                 
      caption = "A higher vertical data replication has a positive impact on time-behavior for the TeaStore application while using a cloud database with one replica database",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis4d", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis4d, 
      label = NA,                
      caption = "A higher vertical data replication has a positive impact on time-behavior for the TeaStore application while using a cloud database with two replica databases",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis4e", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis4e, 
      label = NA,                 
      caption = "A higher vertical data replication has a positive impact on time-behavior for the TeaStore application while there is a low service replication.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis4f", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis4f, 
      label = NA,                 
      caption = "A higher vertical data replication has a positive impact on time-behavior for the TeaStore application while there is a high service replication.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis5a", echo = FALSE, message=FALSE}

columnNames <- c("Entity Type", "Name", "JMeter label", "Variation", "success rate [%]", "Ratio of Cached Data Aggregates", "Data Replication along Request Trace")
columnAlignment <- "llllccc"
withTableStyling<- function(kTable) {
  kTable %>%
  kable_styling(font_size = 11, bootstrap_options = "bordered") %>%
  row_spec(0,bold=TRUE, hline_after=TRUE) %>% 
  column_spec(c(1:7), width = "15em", latex_valign = "m") %>%
  #column_spec(1, width = "15em", latex_valign = "m") %>%
  #column_spec(c(2:3), latex_valign = "m") %>%
  #column_spec(c(4:11), latex_valign = "m") %>%
  #kable_styling(font_size = 10, latex_options=c("scale_down", "HOLD_position")) %>%
...
withTableStyling(kable(hypothesis5a, 
      label = NA,                 
      caption = "A higher vertical data replication has a positive impact on availability for the TeaStore application while there is no service replication.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis5b", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis5b, 
      label = NA,                 
      caption = "A higher vertical data replication has a positive impact on availability for the TeaStore application while there is a low service replication.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
...
```{r "hypothesis5c", echo = FALSE, message=FALSE}

withTableStyling(kable(hypothesis5c, 
      label = NA,                 
      caption = "A higher vertical data replication has a positive impact on availability for the TeaStore application while there is a high service replication.",
      col.names = columnNames,
      longtable = FALSE,
      align = columnAlignment,
      ))
